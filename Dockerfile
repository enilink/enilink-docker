...
RUN mkdir -p /opt/enilink-platform && \
    curl -jksSL https://github.com/enilink/enilink/releases/download/v1.2.3/enilink-platform-1.2.3-linux.gtk.x86_64.tar.gz \
    | tar -xzf - -C /opt/enilink-platform && \
    chmod +x "/opt/enilink-platform/enilink-platform"
